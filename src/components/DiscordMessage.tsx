        ...
        <div className='w-full flex items-start justify-start'>
            ...
            <div className='w-full max-w-xl '>
                <div className="flex items-center">
                    ...
                    <span className="ml-2 px-1 5 py-0.5 text-sm font-semibold bg-brand-600 text-white rounded">App</span>
                    <span className='text-gray-400 ml-1.5 font-normal text-sm'>{timestamp}</span>
                </div>
                <div className='bg-[#2f3136] text-sm w-full rounded p-3 mb-4 mt-1.5'>
                    <div className="flex flex-row items-center justify-between mb-2">
                        {badgeText ? <span className={cn(`inline-flex order-2 items-center rounded-md px-2 py-1 text-sm font-medium ring-1 ring-inset`,
